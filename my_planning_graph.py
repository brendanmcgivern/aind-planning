...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        # Initialize new a_nodes set() to be added to a_levels[]
        a_nodes = set()
    ...
    def add_literal_level(self, level):
        ...
        # Initialize new a_nodes set() to be added to s_levels[]
        s_nodes = set()
        for prev_a_node in self.a_levels[level-1]:
            for s_node in prev_a_node.effnodes:
                # for every s_node set relation (parent, child)
                s_node.parents.add(prev_a_node)
                prev_a_node.children.add(s_node)
                s_nodes.add(s_node)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if set(node_a1.action.effect_add).intersection(node_a2.action.effect_rem) or set(node_a2.action.effect_add).intersection(node_a1.action.effect_rem):
            return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if set(node_a1.action.effect_add).intersection(node_a2.action.precond_neg) or set(node_a1.action.effect_rem).intersection(node_a2.action.precond_pos):
            return True
        if set(node_a2.action.effect_add).intersection(node_a1.action.precond_neg) or set(node_a2.action.effect_rem).intersection(node_a1.action.precond_pos):
            return True
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        # PgNode_s.symbol is the literal expression
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        # s_layer parent is an action layer
